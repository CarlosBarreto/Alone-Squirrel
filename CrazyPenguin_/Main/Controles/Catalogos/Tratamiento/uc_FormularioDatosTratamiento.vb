...
Public Class uc_FormularioDatosTratamiento
    ...
    Private Sub bt_Guardar_Click(sender As System.Object, e As System.EventArgs) Handles bt_Guardar.Click
        Dim x As fr_Main
        DB = New DBDataSource
        GuardarTratamiento(txt_Nombre.Text, txt_Descripcion.Text)
        DB.Dispose()
        DB = Nothing
    ...
    Public Function GuardarTratamiento(ByVal Nombre As String, ByVal Descripcion As String) As DataTable
        Dim DT As DataTable
        Dim strSQL As New StringBuilder

        strSQL.Append("CALL migsa_catalogotratamiento_Insertar(")
